...
@Entity(name="sf_com_acl")
public class SfComAcl implements Serializable {

	private static final long serialVersionUID = -6137869702842220900L;
	...
	@GenericGenerator(name = "sFlowKeyGenerator", strategy = "com.lyplay.sflow.data.util.SFlowKeyGenerator",
			parameters = { @Parameter(name = SFlowKeyGenerator.SEQUENCE_NAME, value = "SEQ_SF_COM_ACL") })
	private String id;
